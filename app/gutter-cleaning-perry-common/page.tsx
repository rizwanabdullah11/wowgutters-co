...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Gutter Cleaning Perry Common Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Perry Common, Birmingham (B23, B24). No ladders, vacuum system, before & after photos. From £45. Call WOW Gutters Ltd: 07421 433910.',
    url: URL_PATH, type: 'website', locale: 'en_GB', siteName: 'WOW Gutters Ltd',
    images: [{ url: 'https://wowgutters.co.uk/og/perry-common.jpg', width: 1200, height: 630, alt: 'WOW Gutters Ltd — Gutter Cleaning Perry Common Birmingham' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gutter Cleaning Perry Common Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Perry Common B23/B24. From £45. No ladders, before & after photos. Call WOW Gutters Ltd: 07421 433910.',
...
const howToSchema = {
  ...
  '@type': 'HowTo',
  name: 'How WOW Gutters Ltd Cleans Your Gutters in Perry Common',

...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Gutter Cleaning Maney Sutton Coldfield | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Maney, Sutton Coldfield (B72). No ladders, vacuum system, before & after photos. From £55. Call WOW Gutters: 07421 433910.',
    url: URL_PATH, type: 'website', locale: 'en_GB', siteName: 'WOW Gutters',
    images: [{ url: 'https://wowgutters.co.uk/og/maney.jpg', width: 1200, height: 630, alt: 'WOW Gutters — Gutter Cleaning Maney Sutton Coldfield' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gutter Cleaning Maney Sutton Coldfield | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Maney B72. From £55. No ladders, before & after photos. Call WOW Gutters: 07421 433910.',

...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Gutter Cleaning Tyseley, Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Tyseley, Birmingham (B11). No ladders, vacuum system, before & after photos. From £45. Call WOW Gutters: 07421 433910.',
    url: URL_PATH, type: 'website', locale: 'en_GB', siteName: 'WOW Gutters',
    images: [{ url: 'https://wowgutters.co.uk/og/tyseley.jpg', width: 1200, height: 630, alt: 'WOW Gutters — Gutter Cleaning Tyseley Birmingham' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gutter Cleaning Tyseley, Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Tyseley B11. From £45. No ladders, before & after photos, 1-year guarantee. Call WOW Gutters: 07421 433910.',
...
const howToSchema = {
  ...
  '@type': 'HowTo',
  name: 'How WOW Gutters Cleans Your Gutters in Tyseley',

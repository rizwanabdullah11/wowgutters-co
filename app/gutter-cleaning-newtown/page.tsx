...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Gutter Cleaning Newtown Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Newtown, Birmingham (B19). No ladders, vacuum system, before & after photos. From £50. Call WOW Gutters: 07421 433910.',
    url: URL_PATH, type: 'website', locale: 'en_GB', siteName: 'WOW Gutters',
    images: [{ url: 'https://wowgutters.co.uk/og/newtown.jpg', width: 1200, height: 630, alt: 'WOW Gutters — Gutter Cleaning Newtown Birmingham' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gutter Cleaning Newtown Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Newtown B19. From £50. No ladders, before & after photos. Call WOW Gutters: 07421 433910.',

...
export const metadata: Metadata = {
  title: 'Gutter Cleaning Mere Green Sutton Coldfield | WOW Gutters Ltd',
  ...
  openGraph: {
    title: 'Gutter Cleaning Mere Green Sutton Coldfield | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Mere Green, Sutton Coldfield (B75). No ladders, vacuum system, before & after photos. From £55. Call WOW Gutters: 07421 433910.',
    url: URL_PATH, type: 'website', locale: 'en_GB', siteName: 'WOW Gutters',
    images: [{ url: 'https://wowgutters.co.uk/og/mere-green.jpg', width: 1200, height: 630, alt: 'WOW Gutters — Gutter Cleaning Mere Green Sutton Coldfield' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gutter Cleaning Mere Green Sutton Coldfield | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Mere Green B75. From £55. No ladders, before & after photos. Call WOW Gutters: 07421 433910.',
...
const howToSchema = {
  ...
  '@type': 'HowTo',
  name: 'How WOW Gutters Cleans Your Gutters in Mere Green',

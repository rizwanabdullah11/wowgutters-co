...
export const metadata: Metadata = {
  title: 'Gutter Cleaning Wylde Green, Sutton Coldfield | WOW Gutters Ltd',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://wowgutters.co.uk/og/wylde-green.jpg', width: 1200, height: 630, alt: 'WOW Gutters — Gutter Cleaning Wylde Green, Sutton Coldfield' }],
  },
  twitter: {

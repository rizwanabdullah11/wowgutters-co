...
export const metadata: Metadata = {
  title: 'Gutter Cleaning Shirley, Solihull | WOW Gutters Ltd',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://wowgutters.co.uk/og/shirley.jpg', width: 1200, height: 630, alt: 'WOW Gutters — Gutter Cleaning Shirley Solihull' }],
  },
  twitter: {

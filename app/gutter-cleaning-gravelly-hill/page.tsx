...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Gutter Cleaning Gravelly Hill Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Gravelly Hill, Birmingham (B23, B24). No ladders, vacuum system, before & after photos. From \u00a345. Call WOW Gutters: 07421 433910.',
    url: URL_PATH, type: 'website', locale: 'en_GB', siteName: 'WOW Gutters',
    images: [{ url: 'https://wowgutters.co.uk/og/gravelly-hill.jpg', width: 1200, height: 630, alt: 'WOW Gutters \u2014 Gutter Cleaning Gravelly Hill Birmingham' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gutter Cleaning Gravelly Hill Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Gravelly Hill B23, B24. From \u00a345. No ladders, before & after photos. Call WOW Gutters: 07421 433910.',
...
const howToSchema = {
  ...
  '@type': 'HowTo',
  name: 'How WOW Gutters Cleans Your Gutters in Gravelly Hill',

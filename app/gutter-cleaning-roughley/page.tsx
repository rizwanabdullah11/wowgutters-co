...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Gutter Cleaning Roughley Sutton Coldfield | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Roughley, Sutton Coldfield (B74). No ladders, vacuum system, before & after photos. From £55. Call WOW Gutters Ltd: 07421 433910.',
    url: URL_PATH, type: 'website', locale: 'en_GB', siteName: 'WOW Gutters Ltd',
    images: [{ url: 'https://wowgutters.co.uk/og/roughley.jpg', width: 1200, height: 630, alt: 'WOW Gutters Ltd — Gutter Cleaning Roughley Sutton Coldfield' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gutter Cleaning Roughley Sutton Coldfield | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Roughley B74. From £55. No ladders, before & after photos. Call WOW Gutters Ltd: 07421 433910.',

...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Gutter Cleaning Birchfield Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Birchfield, Birmingham (B6, B20). No ladders, vacuum system, before & after photos. From \u00a345. Call WOW Gutters Ltd: 07421 433910.',
    url: URL_PATH, type: 'website', locale: 'en_GB', siteName: 'WOW Gutters Ltd',
    images: [{ url: 'https://wowgutters.co.uk/og/birchfield.jpg', width: 1200, height: 630, alt: 'WOW Gutters Ltd \u2014 Gutter Cleaning Birchfield Birmingham' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gutter Cleaning Birchfield Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Birchfield B6, B20. From \u00a345. No ladders, before & after photos. Call WOW Gutters Ltd: 07421 433910.',
...
const howToSchema = {
  ...
  '@type': 'HowTo',
  name: 'How WOW Gutters Ltd Cleans Your Gutters in Birchfield',

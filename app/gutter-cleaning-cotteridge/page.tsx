...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Gutter Cleaning Cotteridge Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Cotteridge, Birmingham (B30). No ladders, vacuum system, before & after photos. From \u00a350. Call WOW Gutters: 07421 433910.',
    url: URL_PATH, type: 'website', locale: 'en_GB', siteName: 'WOW Gutters',
    images: [{ url: 'https://wowgutters.co.uk/og/cotteridge.jpg', width: 1200, height: 630, alt: 'WOW Gutters \u2014 Gutter Cleaning Cotteridge Birmingham' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gutter Cleaning Cotteridge Birmingham | WOW Gutters Ltd',
    description: 'Professional gutter cleaning in Cotteridge B30. From \u00a350. No ladders, before & after photos. Call WOW Gutters: 07421 433910.',
...
const howToSchema = {
  ...
  '@type': 'HowTo',
  name: 'How WOW Gutters Cleans Your Gutters in Cotteridge',

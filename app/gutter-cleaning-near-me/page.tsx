...
import { GUTTER_CLEANING_NEAR_ME_LANDING } from '@/constants/gutterCleaningNearMeLanding';

const URL_PATH = 'https://wowgutters.co.uk/gutter-cleaning-near-me/';

const landingData = GUTTER_CLEANING_NEAR_ME_LANDING;
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'WOW Gutters Ltd - Gutter Cleaning Near Me West Midlands',
      },
    ],
  },
  twitter: {
...
export default function GutterCleaningNearMePage() {
  return (
    <>
      <LocalBusinessSchema
        city="West Midlands"

...
if (!hasLdJson || !hasLocalBusiness) {
  console.error("assert-jsonld: FAILED — homepage export is missing JSON-LD LocalBusiness.");
  console.error({ hasLdJson, hasLocalBusiness });
  process.exit(1);
}

console.log("assert-jsonld: OK — LocalBusiness JSON-LD detected in out/index.html");

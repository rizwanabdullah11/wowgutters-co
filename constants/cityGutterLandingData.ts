...
export const CITY_GUTTER_LANDINGS: Record<string, CityGutterLandingData> = {
  ...
  'acocks-green': {
    slug: 'acocks-green',
    city: 'Acocks Green',
    titleTag: 'Gutter Cleaning Acocks Green, Birmingham | WOW Gutters Ltd — Free Quote',
    metaDescription: 'Professional gutter cleaning in Acocks Green, Birmingham B27. Ground-level vacuum system, no ladders, before & after photos. Call 07421 433910.',
    h1: 'Gutter Cleaning Acocks Green — Professional Service for B27 Properties',
    heroIntro: "WOW Gutters Ltd provides professional gutter cleaning across Acocks Green and the surrounding south-east Birmingham neighbourhoods, including Hall Green, Yardley, Olton, Sheldon and the Solihull border. Acocks Green is a well-established residential suburb with a strong mix of Victorian terraces, Edwardian semis and larger detached homes — all set along tree-lined streets that make the area attractive to live in but demanding on gutters. Our ground-level vacuum system handles all property types safely and efficiently, without ladders, without mess, and with before and after photos on every job.",
    whyTitle: 'Why Acocks Green Gutters Need Regular Cleaning',
    whyBody: [
      "Acocks Green's tree-lined streets are one of its most appealing features — and one of the most consistent causes of gutter blockages. The mature oaks, limes and sycamores lining Warwick Road, Westley Road and the residential streets throughout B27 shed significant volumes of leaves and seeds each autumn. Properties with trees overhanging the roofline can see gutters fill completely within weeks of the first leaf fall.",
    ...
    propertyTypesTitle: 'Gutter Cleaning for All Property Types in Acocks Green',
    propertyTypes: [
      { label: 'Victorian terraces (Warwick Road, Acocks Green village)', detail: 'Older gutter systems with aging joints. We clear carefully from ground level and flag any repairs needed. No side access required in most cases.' },
      { label: 'Edwardian semis (Westley Road, Shirley Road)', detail: 'Larger properties with longer gutter runs and heavy leaf fall from mature garden trees. Full downpipe flush and condition report included.' },
      { label: 'Large detached homes (Olton border, Solihull border)', detail: 'Complex rooflines with multiple sections. Our 4-storey vacuum reach covers every run without scaffolding or cherry pickers.' },
      { label: 'Converted flats and apartments', detail: 'Multi-storey conversions with shared guttering. We coordinate with managing agents and provide photographic evidence for maintenance records.' },
      { label: 'Commercial properties (Warwick Road corridor)', detail: 'Retail units and offices. Planned maintenance contracts available with scheduled visits and written condition reports.' },
    ],
    areasTitle: 'Areas We Cover Around Acocks Green',
    areasInline: 'Hall Green, Yardley, Olton, Sheldon | Tyseley, Small Heath, Sparkhill | Solihull border | Nearby: Birmingham city centre, Solihull, Coventry Road corridor',
    faqsTitle: 'FAQs — Gutter Cleaning Acocks Green',
    faqs: [
      { question: 'How much does gutter cleaning cost in Acocks Green?', answer: 'Prices start from £50 for a standard terraced house. Most semi-detached homes in Acocks Green range from £60–£80, and larger detached properties from £80–£120. Fixed quote before starting — no hidden charges.' },
      { question: 'Do you cover Olton and the Solihull border?', answer: 'Yes — all B27 postcodes and surrounding areas including Olton, Hall Green, Yardley, Sheldon and the Solihull border.' },
      { question: 'Can you clean gutters on large detached homes in Acocks Green?', answer: 'Yes — our 4-storey vacuum reach handles complex rooflines and long gutter runs on larger Acocks Green properties without scaffolding or cherry pickers.' },
      { question: 'Do you offer fascia and soffit cleaning in Acocks Green?', answer: 'Yes — our hot purified water system restores fascias and soffits to a bright, streak-free finish. Popular with Acocks Green homeowners preparing to sell or after a roof replacement.' },
      { question: 'Can blocked gutters cause damp in my Acocks Green property?', answer: 'Yes — particularly in the older Victorian and Edwardian properties throughout B27. Water overflowing from a blocked gutter saturates the external brickwork and can penetrate the interior over time. Annual cleaning is the most cost-effective way to prevent this.' },
      { question: 'Do you offer gutter repairs in Acocks Green?', answer: 'Yes. If our technician spots damaged sections, loose brackets or leaking joints during your clean, we flag these in our condition report. Our repair team can return to carry out the necessary work.' },
      { question: 'How quickly can you get to Acocks Green?', answer: 'We aim to offer bookings within 2–5 working days. Same-day visits may be available — call 07421 433910 to check availability.' },
    ],
    ...
    ctaHeading: 'Book Your Gutter Clean in Acocks Green — Free Quote in 60 Seconds',
  },

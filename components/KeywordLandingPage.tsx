...
function faqItems(cat: string, page: KeywordPage): { question: string; answer: string }[] {
  ...
  return [
    ...
    { question: 'Are you insured?', answer: 'Yes — we hold £10 million public liability insurance and thoroughly flow-test every job.' },
  ];
}
...
export default function KeywordLandingPage({ page }: { page: KeywordPage }) {
  ...
  return (
    <main className="bg-white area-page-wrapper">
      ...
      {/* COMPLETE PROPERTY SERVICES & HYPERLINKS */}
      <section className="py-16 px-4 bg-slate-50 border-t border-slate-200/60">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
              Complete Exterior Property Solutions &amp; Maintenance
            </h2>
            <p className="text-slate-600 text-base md:text-lg leading-relaxed">
              In addition to our high-reach vacuum gutter clearance, WOW Gutters Ltd provides a comprehensive range of exterior maintenance services, fixed-rate pricing tools, and special discount programs across the West Midlands.
            </p>
          </div>
      ...
      {page.slug.includes('commercial-roof-cleaning-') || page.slug.includes('commercial-gutter-cleaning-') || page.slug.includes('commercial-gutter-clearing-') ? (
        <section className="py-16 md:py-20 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4 text-center">
              Commercial {page.slug.includes('roof') ? 'Roof Cleaning' : 'Gutter Cleaning'} <span style={{ color: colors.primary }}>Gallery</span>
            </h2>
            <p className="text-slate-600 text-lg text-center mb-10 max-w-2xl mx-auto">
              See examples of our commercial {page.slug.includes('roof') ? 'roof cleaning' : 'gutter cleaning'} work — before, during and after treatment.
            </p>

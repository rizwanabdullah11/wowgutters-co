      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: '🔍', title: 'Gutter Condition', desc: 'Check for cracks, rust, and structural damage' },
              { icon: '💧', title: 'Water Flow', desc: 'Test drainage and identify blockages' },
              { icon: '🔗', title: 'Joints & Seals', desc: 'Inspect for leaks and loose connections' },
              { icon: '📏', title: 'Alignment', desc: 'Check for sagging or improper slope' },
              { icon: '🏠', title: 'Fascia & Soffit', desc: 'Examine for water damage and rot' },
              { icon: '🍂', title: 'Debris Build-up', desc: 'Assess cleaning requirements' },
            ].map((item, i) => (
              <div
                key={i}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Our comprehensive gutter inspection service identifies potential problems before they become
                costly repairs. We thoroughly examine every component of your gutter system to ensure optimal
                performance and protection for your property.
              </p>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Using advanced inspection techniques, our qualified technicians assess the condition of gutters,
                downpipes, joints, and fascia boards. We provide detailed photographic evidence and a comprehensive
                written report highlighting any issues discovered.
              </p>

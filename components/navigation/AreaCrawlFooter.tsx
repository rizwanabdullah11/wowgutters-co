...
export default function AreaCrawlFooter({ currentSlug }: { currentSlug?: string }) {
  return (
    <nav
      aria-label="More gutter cleaning service areas"
    ...
    >
      <div className="max-w-6xl mx-auto text-center">
        ...
        <h2 className="text-xl font-black text-slate-900 mb-3">Find gutter cleaning near you</h2>

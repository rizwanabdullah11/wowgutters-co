  ...
  return (
    <main className="bg-white area-page-wrapper">
      ...
      <AreaServiceBlock
        ...
        descriptions={[
          `WOW Gutters Ltd is highly rated with verified Google reviews. Our ${formattedArea} customers consistently highlight our punctuality, the quality of our before and after photos, and the honesty of our condition reports.`,

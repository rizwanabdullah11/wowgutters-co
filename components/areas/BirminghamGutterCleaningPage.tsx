...
const PDF_PROPERTY_ROWS: { type: string; issue: string; approach: string }[] = [
  ...
  },
  {
    ...
    approach: 'Quick, affordable clean; same professional standard and flow testing',
  },
  {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
              Complete Exterior Property Solutions in Birmingham
            </h2>
            <p className="text-slate-600 text-base md:text-lg leading-relaxed">
              In addition to our high-reach vacuum gutter clearance, WOW Gutters Ltd provides a comprehensive range of exterior maintenance services, fixed-rate pricing tools, and special discount programs for Birmingham residents.
            </p>
          </div>

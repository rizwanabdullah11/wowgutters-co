...
export default function AskQuestionSection() {
  const whatsappNumber = '447421433910';
  ...
  const handleAskQuestion = (question: string) => {
    ...
    window.open(`${whatsappBaseUrl}${whatsappNumber}?text=${encodedQuestion}`, '_blank');
  };
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <h2 className="text-4xl md:text-5xl font-black mb-6 leading-tight">
              ...
              <br />
              <span style={{ color: colors.primary }}>Reach out via WhatsApp</span>
            </h2>

            <p className="text-lg text-gray-300 leading-relaxed mb-8">
              Expect prompt engagement from our designated Walsall crew. Forward a single text, and we will immediately clarify pricing structures, availability metrics, and repair strategies.
            </p>
